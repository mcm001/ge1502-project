...
public class FindBoardCornersPipe
    ...
    */
    private Size getFindCornersImgSize(Mat inFrame) {
        long findcorners_height = Math.round(inFrame.height() * getFindCornersScaleFactor(inFrame));
    ...
    */
    private Triple<Size, Mat, Mat> findBoardCorners(Pair<Mat, Mat> in) {
        ...
        Mat inFrame = in.getLeft();
        Mat outFrame = in.getRight();
        ...
        MatOfPoint2f outBoardCorners = new MatOfPoint2f();
