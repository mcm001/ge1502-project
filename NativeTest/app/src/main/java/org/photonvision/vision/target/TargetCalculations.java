...
public class TargetCalculations {
    ...
    public static Point calculateRobotOffsetPoint(
        ...
        switch (offsetMode) {
            ...
            case Dual:
                ...
                DoubleCouple lineValues = dualOffsetValues.getLineValues();
                Double offsetSlope = lineValues.getFirst();
                Double offsetIntercept = lineValues.getSecond();
    ...
    public static Point calculateDualOffsetCrosshair(
        ...
        double areaFraction = MathUtils.map(currentArea, lowerArea, upperArea, 0, 1);
        double xLerp =
    ...
    public static DoubleCouple getLineFromPoints(Point firstPoint, Point secondPoint) {
        double offsetLineSlope = (secondPoint.y - firstPoint.y) / (secondPoint.x - firstPoint.x);
        double offsetLineIntercept = firstPoint.y - (offsetLineSlope * firstPoint.x);
