...
public class FindCirclesPipe
    ...
    */
    ...
    protected List<CVShape> process(Pair<Mat, List<Contour>> in) {
        ...
        double diag = params.diagonalLengthPx;
        int minRadius = (int) (params.minRadius * diag / 100.0);
        int maxRadius = (int) (params.maxRadius * diag / 100.0);
        ...
        List<Contour> unmatchedContours = in.getRight();
        ...
        for (Contour c : unmatchedContours) c.release();
