...
public final class StateSpaceUtil {
    ...
    public static <I extends Num> Matrix<I, N1> clampInputMaxMagnitude(
        ...
        Matrix<I, N1> result = new Matrix<>(new SimpleMatrix(u.getNumRows(), 1));
    ...
    public static Matrix<N5, N1> poseTo5dVector(Pose2d poseMeters) {
        return VecBuilder.fill(
                poseMeters.getX(),
                poseMeters.getY(),
                0, 0,
                poseMeters.getRotation().getRadians()
        );
    }
}
